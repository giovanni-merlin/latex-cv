...
\begin{minipage}[t]{0.27\textwidth} % 27% of the page width for the second row of icons
	...
	\icon{Envelope}{11}{\href{mailto:giovanni.merlin@phd.unipd.it}{giovanni.merlin@phd.unipd.it}}\\	
...
\begin{minipage}[t]{0.46\textwidth}
    ...
    %Dummy text
	Physics PhD candidate at University of Padova (IT), establishing a new trapped ion platoform. Enthusiastic about hands-on laboratory work and driven by a curiosity to develop solutions to scientific and technical problems. \\
...
\begin{entrylist}
	\entry
		...
		{Visiting PhD}
		{ETH  Zurich (CH)}
            {\textit{Trapped-Ion Quantum Information Group - Supervisor: Prof. Jonathan Home}
            }
\end{entrylist}
...
\begin{entrylist}
	\entry
		...
		{University of Padova}
            {\textit{Quantum Information and Matter Group - Supervisor: Prof. Simone Montangero.}

            - Title of the thesis: \textit{Development of a trapped ion quantum processor}.
            }
\end{entrylist}
...
\begin{entrylist}
	\entry
		...
		{Research Fellow}
		{University of Padova}
            {\textit{Quantum Information and Matter Group - Prof. Simone Montangero. Supervisor: Dr. Carmelo Mordini}

            - Recipient of a six-months research fellowship to help establishing a new trapped ion platform
...
\begin{entrylist}
	\entry
		...
		{University of Padova}
            ...
            - Developed a fine-tracking system for the local telescope, improving the efficiency of free-space satellite Quantum Key Distribution.
            }
\end{entrylist}
...
\begin{entrylist}
    \entry
		...
		{University of Padova}
        {Title of the thesis: \textit{Optimization of preparation and imaging of ultracold $^{39}$K atoms}}
		%{Merges and innovates the educational offers from Physics and Data Science.}
    \entry
		{10/2018 - 10/2022}
		{Bachelor's Degree in Physics, \small{mark 106/110}}
		{University of Padova}
        {Title of the thesis: \textit{Development and test of a pointing system for satellite tracking}}
